...
> Jean Paul
>
>https://www.linkedin.com/in/jeanpaull/
...
- No recebimento de pagamento, o usuário ou lojista precisa receber notificação (envio de email, sms) enviada por um
  ...
  envio (http://o4d9z.mocklab.io/notify).
...
A correção objetiva será realizada através da utilização de um script de correção automatizada. Você **pode** rodar na
sua máquina local ou usar outra ferramenta:
